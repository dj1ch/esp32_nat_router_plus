...
esp_err_t ota_update_handler(httpd_req_t *req)
{
  ...
  ESP_LOGI(TAG, "Writing partition: type %d, subtype %d, offset 0x%08lx\n",
          update_partition->type, update_partition->subtype, (unsigned long)update_partition->address);
  ESP_LOGI(TAG, "Running partition: type %d, subtype %d, offset 0x%08lx\n",
          running_partition->type, running_partition->subtype, (unsigned long)running_partition->address);
